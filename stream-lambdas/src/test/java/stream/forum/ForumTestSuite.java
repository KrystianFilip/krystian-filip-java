...
public class ForumTestSuite {
    @Test
    public void testGetLocationInception() {
        //Given
        //Create users
        ...
        Assert.assertEquals(3,user1.getLocationInception().size());
        Assert.assertTrue(user1.getLocationInception().contains("Key West"));
        Assert.assertTrue(user1.getLocationInception().contains("Washington"));
        Assert.assertTrue(user1.getLocationInception().contains("Miami"));
        Assert.assertFalse(user1.getLocationInception().contains("Orlando"));
    }
}
